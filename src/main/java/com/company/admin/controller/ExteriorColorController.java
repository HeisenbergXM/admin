...
public class ExteriorColorController {
    ...
    public Result<Void> updateExteriorColor(@Parameter(description = "主键 ID") @PathVariable Long id,
    ...
    public Result<Void> deleteExteriorColor(@Parameter(description = "主键 ID") @PathVariable Long id) {
    ...
    public Result<Void> toggleExteriorColorStatus(@Parameter(description = "主键 ID") @PathVariable Long id,
                                                  @Valid @RequestBody StatusUpdateRequest request) {
        exteriorColorService.toggleExteriorColorStatus(id, request.getStatus());
        return Result.success();
    }
}
